...
const LostItems = () => {
    ...
    const renderLostItem = ({ item, index }: { item: any; index: number }) => {
    ...
    return (
        <View className="flex-1 bg-gray-50">
            ...
            <View className="bg-white pt-12 pb-6 px-6 shadow-sm">
                <Text className="text-2xl font-bold text-center text-gray-800 mb-2">Lost Items</Text>
                <Text className="text-gray-500 text-center">View all reported lost items</Text>
            </View>
                ...
                {loading ? (
                    ...
                    <View className="flex-1 items-center justify-center">
                        ...
                        <Text className="text-center text-sm text-gray-400">
                            {dateFilter ? `Try adjusting your date filter` : `Lost items will appear here when reported`}
                        </Text>
                    </View>
                )}
            </View>
